...
class MainMiddleware(BaseMiddleware):
    async def __call__(
        ...
        if user_profile.count_request >= 0 and status_1.status in (ChatMemberStatus.LEFT, ChatMemberStatus.KICKED):
        ...
        elif user_profile.count_request >= 3 and status_2.status in (ChatMemberStatus.LEFT, ChatMemberStatus.KICKED):
